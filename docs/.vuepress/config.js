  ...
  themeConfig: {
    ...
    nav: [
      { text: '🏠 首页', link: '/' },
      {
        ...
        link: '/frontend/',
        items: [
          { text: '📗 《CSS 教程》', link: '/pages/9cb98c/' },
          { text: '📗 《HTMl 教程》', link: '/html/course/' },
          { text: '📗 《JavaScript教程》', link: '/pages/0796ba76b4b55368/' },
          { text: '📗 《ES6 教程》', link: '/es6/f344d070a1031ef7/' },
          { text: '📗 《TypeScript 教程》', link: '/typescript/course/' },
          { text: '📗 《React 教程》', link: '/React/course/' },
          { text: '📗 《Vue 教程》', link: '/vue/course/' },
